...
def assigned_queue(user_email_address, psql):
    ...
    try:
        ...
        cur.execute(
            f"select * from cbi_certification_queue where reviewer='{user_email_address}' ;")
...
def reviewer_workspace(user_email_address, notes, psql):
    ...
    try:
        ...
        try:
            ...
            cur.execute(f"SELECT * from cbi_reviewer_workspace  WHERE user_email_address='{user_email_address}'")
            data = cur.fetchone()
            con.commit()
